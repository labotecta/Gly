...
if (tot_resultados){
  ...
  fiacto_mejorZU   <- paste(sep="",casoa,"_muestra_",porcentaje_entrenar,"_cambiar_Cartesianas_resultados_Azu",desamb,".csv")
  fimejorZU        <- paste(sep="",casoa,"_muestra_",porcentaje_entrenar,"_cambiar_Cartesianas_resultados_Mzu",desamb,".csv")
}
fi <- paste(sep="",casoa,"_muestra_",porcentaje_entrenar,"_cambiar_Cartesianas_log",desamb,".txt")
...
if (tot_salidas){
  fitot <- paste(sep="",casoa,"_muestra_",porcentaje_entrenar,"_cambiar_Cartesianas_resultados_TT",desamb,".csv")
...
if (tot_resultados){
  write.table(aciertosXY_mejorZU, file=paste(sep="",casob,"_muestra_",porcentaje_entrenar,"cambiar_Cartesianas_grafico3d",desamb,".csv"), row.names=FALSE, col.names=TRUE, sep=";", dec=",")
  if (require(lattice)){
    wireframe(
  ...
  if (require(rgl)){
    ...
    snapshot3d(paste(sep="",casob,"_muestra_",porcentaje_entrenar,"cambiar_Cartesianas_grafico3d_a",desamb,".png"), top=TRUE)
  }
}
...
write.table(datosprobar, file=paste(sep="",casob,"_muestra_",porcentaje_entrenar,"cambiar_Cartesianas_muestraP",desamb,".csv"), row.names=FALSE, col.names=TRUE, sep=";", dec=",")
